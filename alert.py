...
trip_date = datetime(2025, 4, 29)  # What is the latest appointment you want? 
sessions_token = "https://www.ch-edoc-reservation.admin.ch/#/session?token=9Z4gXVsj&locale=en-US" # Obtain this link from the email directly
